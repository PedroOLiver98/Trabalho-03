...
while (quadro <= 64) {
    ...
    document.body.innerHTML += `Quadro ${quadro}: ${graos} grãos - Total acumulado: ${totalGraos} grãos <br>`;
    graos *= 2;  // Dobramos a quantidade de grãos para o próximo quadro
    quadro++;  // Incrementamos o quadro
}

document.body.innerHTML += `Total de grãos no tabuleiro de xadrez: ${totalGraos} grãos. <br>`;
